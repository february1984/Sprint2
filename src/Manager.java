...
public class Manager {
    ...
    public static HashMap<String, Task> deleteTask (String taskToDelete, HashMap<String, Task> currentTaskList) throws IOException {
        HashMap<String, Task> taskListDeleteFrom = loadTaskFromFile();
        taskListDeleteFrom.remove(taskToDelete);
        Manager.deleteAllTasks(currentTaskList);
        for (String key : taskListDeleteFrom.keySet()) {
            Manager.saveTaskToFile(taskListDeleteFrom.get(key));
        }
        return taskListDeleteFrom;
    }
    public static HashMap<String,Task> updateTask (String taskToUpdateName, HashMap<String, Task> currentTaskList) throws IOException{
        HashMap<String, Task> taskListToUpdate = loadTaskFromFile();
